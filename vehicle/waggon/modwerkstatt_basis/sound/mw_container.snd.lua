...
return {
	tracks = {
		{ name = "basis/mw_container/start.wav", refDist = 3.0 },
		{ name = "basis/mw_container/normal.wav", refDist = 3.0 },
		{ name = "basis/mw_container/fast.wav", refDist = 3.0 },
		...
		events = {
			...
			names = {
				...
				"basis/sfx/container_clack/clack2.wav",
				"basis/sfx/container_clack/clack3.wav",
				"basis/sfx/container_clack/clack4.wav",
				"basis/sfx/container_clack/clack5.wav",
				"basis/sfx/container_clack/clack6.wav",
				"basis/sfx/container_clack/clack7.wav",
				"basis/sfx/container_clack/clack8.wav"
