...
return {
	tracks = {
		{ name = "basis/mw_person_modern/slow.wav", refDist = 3.0 },
		{ name = "basis/mw_person_modern/normal.wav", refDist = 3.0 },
		{ name = "basis/mw_person_modern/fast.wav", refDist = 3.0 },
		{ name = "basis/mw_person_modern/kurve.wav", refDist = 5.0 },
		{ name = "basis/mw_person_modern/bremse_mix.wav", refDist = 6.0 }
	},
	events = {
		clacks = {
		    -- Klackern
