...
return {
	tracks = {
		{ name = "basis/mw_schiebewand/start.wav", refDist = 3.0 },
		{ name = "basis/mw_schiebewand/slow.wav", refDist = 3.0 },
		{ name = "basis/mw_schiebewand/normal.wav", refDist = 3.0 },
		{ name = "basis/mw_schiebewand/fast.wav", refDist = 3.0 },
